...
org.puremvc.haxe.multicore.utilities.statemachine = {}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.mediator.Mediator.apply(this,["StateMachine"]);
	this.states = new Hash();
}}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.__name__ = ["org","puremvc","haxe","multicore","utilities","statemachine","StateMachine"];
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.__super__ = org.puremvc.haxe.multicore.patterns.mediator.Mediator;
for(var k in org.puremvc.haxe.multicore.patterns.mediator.Mediator.prototype ) org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype[k] = org.puremvc.haxe.multicore.patterns.mediator.Mediator.prototype[k];
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.canceled = null;
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.currentState = null;
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.getCurrentState = function() {
	return this.viewComponent;
}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.handleNotification = function(note) {
	switch(note.getName()) {
...
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.initial = null;
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.listNotificationInterests = function() {
	return ["StateMachine" + "/notes/action","StateMachine" + "/notes/cancel"];
}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.onRegister = function() {
	if(this.initial != null) this.transitionTo(this.initial);
}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.registerState = function(state,initial) {
	if(initial == null) initial = false;
	if(state == null || this.states.exists(state.name)) return;
	this.states.set(state.name,state);
	if(initial) this.initial = state;
}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.removeState = function(stateName) {
	if(this.states.exists(stateName)) this.states.remove(stateName);
}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.setCurrentState = function(state) {
	this.viewComponent = state;
	return state;
}
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.states = null;
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.transitionTo = function(nextState) {
...
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.prototype.__class__ = org.puremvc.haxe.multicore.utilities.statemachine.StateMachine;
...
org.puremvc.haxe.multicore.utilities.statemachine.State = function(name,entering,exiting) { if( name === $_ ) return; {
	this.name = name;
	if(entering != null) this.entering = entering;
	if(exiting != null) this.exiting = exiting;
	this.transitions = new Hash();
}}
org.puremvc.haxe.multicore.utilities.statemachine.State.__name__ = ["org","puremvc","haxe","multicore","utilities","statemachine","State"];
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.defineTrans = function(action,target) {
	if(this.getTarget(action) != null) return;
	this.transitions.set(action,target);
}
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.entering = null;
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.exiting = null;
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.getTarget = function(action) {
	return this.transitions.get(action);
}
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.name = null;
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.removeTrans = function(action) {
	this.transitions.remove(action);
}
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.transitions = null;
org.puremvc.haxe.multicore.utilities.statemachine.State.prototype.__class__ = org.puremvc.haxe.multicore.utilities.statemachine.State;
...
org.puremvc.haxe.multicore.demos = {}
org.puremvc.haxe.multicore.demos.xinf = {}
org.puremvc.haxe.multicore.demos.xinf.stopwatch = {}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy = {}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.proxy.Proxy.apply(this,["StopWatchProxy"]);
	this.timer = new org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer($closure(this,"onTick"),1000);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","proxy","StopWatchProxy"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.__super__ = org.puremvc.haxe.multicore.patterns.proxy.Proxy;
for(var k in org.puremvc.haxe.multicore.patterns.proxy.Proxy.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype[k] = org.puremvc.haxe.multicore.patterns.proxy.Proxy.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.displayTime = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.elapsed = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.freeze = function() {
	this.sendNotification("StopWatchProxy" + "/notes/lap",this.getDisplayTime());
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.getDisplayTime = function() {
	var time = this.getElapsed();
	return { h : time.getHours(), m : time.getMinutes(), s : time.getSeconds()}
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.getElapsed = function() {
	return Date.fromTime(this.now.getTime() - this.start.getTime());
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.now = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.onTick = function() {
	this.now = Date.now();
	this.sendNotification("StopWatchProxy" + "/notes/tick",this.getDisplayTime());
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.resetTimer = function() {
	this.timer.reset();
	this.start = Date.now();
	this.now = this.start;
	this.sendNotification("StopWatchProxy" + "/notes/reset",this.getDisplayTime());
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.start = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.startTimer = function() {
	this.timer.start();
	this.sendNotification("StopWatchProxy" + "/notes/sync",this.getDisplayTime());
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.stopTimer = function() {
	this.timer.stop();
	this.now = Date.now();
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.timer = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer = function(callBack,milliInterval,maxTicks) { if( callBack === $_ ) return; {
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","proxy","Timer"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.callBack = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.maxTicks = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.milliInterval = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.reset = function() {
	this.ticks = 0;
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.start = function() {
	this.stopped = false;
	haxe.Timer.delay($closure(this,"tick"),this.milliInterval);
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.stop = function() {
	this.stopped = true;
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.stopped = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.tick = function() {
	if(this.stopped || this.ticks == this.maxTicks) return;
	this.callBack();
	this.ticks++;
	haxe.Timer.delay($closure(this,"tick"),this.milliInterval);
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.ticks = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.Timer;
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller = {}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","InjectFSMCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand.prototype.execute = function(note) {
	...
	var injector = new org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector(fsm);
	injector.initializeNotifier(this.multitonKey);
	injector.inject();
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand;
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","PrepModelCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand.prototype.execute = function(note) {
	this.getFacade().registerProxy(new org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy());
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand;
xinf.ony._Path = {}
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view = {}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator = function(viewComponent) { if( viewComponent === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.mediator.Mediator.apply(this,["ApplicationMediator",viewComponent]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","view","ApplicationMediator"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.__super__ = org.puremvc.haxe.multicore.patterns.mediator.Mediator;
for(var k in org.puremvc.haxe.multicore.patterns.mediator.Mediator.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype[k] = org.puremvc.haxe.multicore.patterns.mediator.Mediator.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype.app = null;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype.getApp = function() {
	return this.viewComponent;
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype.handleEvent = function(event) {
	switch(event.type) {
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype.handleNotification = function(note) {
	switch(note.getName()) {
	...
	case "StateMachine" + "/notes/changed":{
		this.getApp().setState(function($this) {
			...
			$r = (Std["is"](tmp,org.puremvc.haxe.multicore.utilities.statemachine.State)?tmp:function($this) {
				var $r;
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype.listNotificationInterests = function() {
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype.onRegister = function() {
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator;
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.MacroCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","StartupCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.MacroCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.MacroCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.MacroCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand.prototype.initializeMacroCommand = function() {
	this.addSubCommand(org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepModelCommand);
	this.addSubCommand(org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand);
	this.addSubCommand(org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.InjectFSMCommand);
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand;
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","EnsureTimerCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand.prototype.execute = function(note) {
	var proxy = function($this) {
		var $r;
		var tmp = $this.getFacade().retrieveProxy("StopWatchProxy");
		$r = (Std["is"](tmp,org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy)?tmp:function($this) {
			var $r;
			throw "Class cast error";
			return $r;
		}($this));
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand;
...
StopWatch = function(p) { if( p === $_ ) return; {
	...
	org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.getInstance("StopWatch").startup(this);
}}
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","ResetDisplayCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand.prototype.execute = function(note) {
	var proxy = function($this) {
		var $r;
		var tmp = $this.getFacade().retrieveProxy("StopWatchProxy");
		$r = (Std["is"](tmp,org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy)?tmp:function($this) {
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand;
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","FreezeDisplayCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand.prototype.execute = function(note) {
	var proxy = function($this) {
		var $r;
		var tmp = $this.getFacade().retrieveProxy("StopWatchProxy");
		$r = (Std["is"](tmp,org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy)?tmp:function($this) {
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand;
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade = function(key) { if( key === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.facade.Facade.apply(this,[key]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","ApplicationFacade"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.__super__ = org.puremvc.haxe.multicore.patterns.facade.Facade;
for(var k in org.puremvc.haxe.multicore.patterns.facade.Facade.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.prototype[k] = org.puremvc.haxe.multicore.patterns.facade.Facade.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.getInstance = function(key) {
	if(org.puremvc.haxe.multicore.patterns.facade.Facade.instanceMap == null) org.puremvc.haxe.multicore.patterns.facade.Facade.instanceMap = new Hash();
	if(!org.puremvc.haxe.multicore.patterns.facade.Facade.instanceMap.exists(key)) org.puremvc.haxe.multicore.patterns.facade.Facade.instanceMap.set(key,new org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade(key));
	return function($this) {
		var $r;
		var tmp = org.puremvc.haxe.multicore.patterns.facade.Facade.instanceMap.get(key);
		$r = (Std["is"](tmp,org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade)?tmp:function($this) {
			var $r;
			throw "Class cast error";
			return $r;
		}($this));
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.prototype.initializeController = function() {
	org.puremvc.haxe.multicore.patterns.facade.Facade.prototype.initializeController.apply(this,[]);
	this.registerCommand("startup",org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StartupCommand);
	this.registerCommand("ensureTimer",org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.EnsureTimerCommand);
	this.registerCommand("resetDisplay",org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.ResetDisplayCommand);
	this.registerCommand("freezeDisplay",org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.FreezeDisplayCommand);
	this.registerCommand("stopTimer",org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand);
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.prototype.startup = function(app) {
	this.sendNotification("startup",app);
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade;
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","PrepViewCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand.prototype.execute = function(note) {
	...
	this.getFacade().registerMediator(new org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator(app));
}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.PrepViewCommand;
...
xinf.geom.TransformList = function(list) { if( list === $_ ) return; {
	this.l = new List();
	if(list != null) { var $it57 = list.iterator();
	while( $it57.hasNext() ) { var item = $it57.next();
	this.l.add(item);
	}}
	this.cache();
}}
...
xinf.geom.TransformList.prototype.cache = function() {
	...
	{ var $it58 = this.l.iterator();
	while( $it58.hasNext() ) { var item = $it58.next();
	{
...
xinf.geom.TransformList.prototype.isIdentity = function() {
	{ var $it59 = this.l.iterator();
	while( $it59.hasNext() ) { var item = $it59.next();
	{
...
xinf.style.StyleSheet.prototype.addMany = function(_rules) {
	{ var $it61 = _rules.iterator();
	while( $it61.hasNext() ) { var rule = $it61.next();
	this.add(rule);
	}}
}
...
haxe.Http.prototype.request = function(post) {
	...
	else { var $it63 = this.params.keys();
	while( $it63.hasNext() ) { var p = $it63.next();
	{
		if(uri == null) uri = "";
		else uri += "&";
	...
	{ var $it65 = this.headers.keys();
	while( $it65.hasNext() ) { var h = $it65.next();
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand = function(p) { if( p === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.command.SimpleCommand.apply(this,[]);
}}
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand.__name__ = ["org","puremvc","haxe","multicore","demos","xinf","stopwatch","controller","StopTimerCommand"];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand.__super__ = org.puremvc.haxe.multicore.patterns.command.SimpleCommand;
for(var k in org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype ) org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand.prototype[k] = org.puremvc.haxe.multicore.patterns.command.SimpleCommand.prototype[k];
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand.prototype.execute = function(note) {
	var proxy = function($this) {
		var $r;
		var tmp = $this.getFacade().retrieveProxy("StopWatchProxy");
		$r = (Std["is"](tmp,org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy)?tmp:function($this) {
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand.prototype.__class__ = org.puremvc.haxe.multicore.demos.xinf.stopwatch.controller.StopTimerCommand;
...
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector = function(fsm) { if( fsm === $_ ) return; {
	org.puremvc.haxe.multicore.patterns.observer.Notifier.apply(this,[]);
	this.fsm = fsm;
}}
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.__name__ = ["org","puremvc","haxe","multicore","utilities","statemachine","FSMInjector"];
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.__super__ = org.puremvc.haxe.multicore.patterns.observer.Notifier;
for(var k in org.puremvc.haxe.multicore.patterns.observer.Notifier.prototype ) org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype[k] = org.puremvc.haxe.multicore.patterns.observer.Notifier.prototype[k];
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.createState = function(stateDef) {
	var name = stateDef.get("name");
	var exiting = stateDef.get("exiting");
	var entering = stateDef.get("entering");
	var state = new org.puremvc.haxe.multicore.utilities.statemachine.State(name,entering,exiting);
	{ var $it66 = stateDef.elementsNamed("transition");
	while( $it66.hasNext() ) { var transDef = $it66.next();
	{
...
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.fsm = null;
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.getStates = function() {
	if(this.stateList == null) {
		this.stateList = new List();
		{ var $it67 = this.fsm.elementsNamed("state");
		while( $it67.hasNext() ) { var stateDef = $it67.next();
		{
...
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.inject = function() {
	var stateMachine = new org.puremvc.haxe.multicore.utilities.statemachine.StateMachine();
	{ var $it68 = this.getStates().iterator();
	while( $it68.hasNext() ) { var state = $it68.next();
	{
		stateMachine.registerState(state,this.isInitial(state.name));
	}
	}}
	this.getFacade().registerMediator(stateMachine);
}
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.isInitial = function(stateName) {
	var initial = this.fsm.get("initial");
	return (stateName == initial);
}
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.stateList = null;
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.states = null;
org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector.prototype.__class__ = org.puremvc.haxe.multicore.utilities.statemachine.FSMInjector;
...
org.puremvc.haxe.multicore.core.View.prototype.notifyObservers = function(notification) {
	if(this.observerMap.exists(notification.getName())) {
		...
		{ var $it69 = iterator;
		while( $it69.hasNext() ) { var observer = $it69.next();
...
org.puremvc.haxe.multicore.core.View.prototype.removeObserver = function(notificationName,notifyContext) {
	...
	{ var $it70 = observers.iterator();
	while( $it70.hasNext() ) { var observer = $it70.next();
	{
...
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.NAME = "StateMachine";
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.ACTION = "StateMachine" + "/notes/action";
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.CHANGED = "StateMachine" + "/notes/changed";
org.puremvc.haxe.multicore.utilities.statemachine.StateMachine.CANCEL = "StateMachine" + "/notes/cancel";
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.NAME = "StopWatchProxy";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.SYNC = "StopWatchProxy" + "/notes/sync";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.TICK = "StopWatchProxy" + "/notes/tick";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.LAP = "StopWatchProxy" + "/notes/lap";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.proxy.StopWatchProxy.RESET = "StopWatchProxy" + "/notes/reset";
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.view.ApplicationMediator.NAME = "ApplicationMediator";
...
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.STARTUP = "startup";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.ENSURE_TIMER = "ensureTimer";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.RESET_DISPLAY = "resetDisplay";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.FREEZE_DISPLAY = "freezeDisplay";
org.puremvc.haxe.multicore.demos.xinf.stopwatch.ApplicationFacade.STOP_TIMER = "stopTimer";
